...
colnames(extracteddata)<-sub("^t", "Time ", colnames(extracteddata))
colnames(extracteddata)<-sub("^f", "Frequency ", colnames(extracteddata))
colnames(extracteddata)<-sub("BodyAcc", "Body Accelaration ", colnames(extracteddata))
colnames(extracteddata)<-sub("GravityAcc", "Gravity Acceleration ", colnames(extracteddata))
colnames(extracteddata)<-sub("BodyGyro", "Body Angular Velocity ", colnames(extracteddata))
colnames(extracteddata)<-sub(".mean.", " Mean ", colnames(extracteddata))
colnames(extracteddata)<-sub(".std.", " StandardDev ", colnames(extracteddata))
colnames(extracteddata)<-sub("Mag", " Magnitude ", colnames(extracteddata))
